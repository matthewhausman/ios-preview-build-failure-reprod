...
describe("AppRegistry", () => {
  describe("getApplication", () => {
    ...
    test('returns "element" and "getStyleElement"', () => {
      import__.default.registerComponent("App", () => NoopComponent);
      const { element, getStyleElement } = import__.default.getApplication("App", {});
    ...
    test('"getStyleElement" adds props to <style>', () => {
      ...
      import__.default.registerComponent("App", () => NoopComponent);
      const { getStyleElement } = import__.default.getApplication("App", {});
    ...
    test('"getStyleElement" contains style updates', () => {
      ...
      const AlternativeComponent = () => import_react.default.createElement(import_View.default, { style: styles.root });
