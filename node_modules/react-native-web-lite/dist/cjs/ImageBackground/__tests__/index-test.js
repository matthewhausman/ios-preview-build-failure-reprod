...
describe("components/ImageBackground", () => {
  ...
  describe('prop "imageStyle"', () => {
    test("sets the style of the underlying Image", () => {
      ...
      const { container } = (0, import_react.render)(/* @__PURE__ */ (0, import_jsx_runtime.jsx)(import__.default, { imageStyle }));
      expect(
  ...
  describe('prop "style"', () => {
    test("sets the style of the container View", () => {
      ...
      const { container } = (0, import_react.render)(/* @__PURE__ */ (0, import_jsx_runtime.jsx)(import__.default, { style }));
