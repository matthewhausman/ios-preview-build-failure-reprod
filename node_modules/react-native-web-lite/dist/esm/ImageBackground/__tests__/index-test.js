...
describe("components/ImageBackground", () => {
  describe('prop "children"', () => {
    test("render child content", () => {
      const { getByText } = render(
        /* @__PURE__ */ jsx(ImageBackground, { children: /* @__PURE__ */ jsx(Text, { children: "Hello World!" }) })
      );
  ...
  describe('prop "imageStyle"', () => {
    test("sets the style of the underlying Image", () => {
      ...
      const { container } = render(/* @__PURE__ */ jsx(ImageBackground, { imageStyle }));
      expect(
  ...
  describe('prop "style"', () => {
    test("sets the style of the container View", () => {
      ...
      const { container } = render(/* @__PURE__ */ jsx(ImageBackground, { style }));
